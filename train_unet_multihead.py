...
# Change this for each repeated run
# SEED = 42
# SEED = 123
SEED = 2025
...
# Configuration 1: current equal weighting
# EXPERIMENT_NAME = "equal"
# W_MASK = 1.0
# W_CENTERLINE = 1.0
# W_JUNCTION = 1.0

# Configuration 2: reduced auxiliary weighting
# EXPERIMENT_NAME = "aux05"
# W_MASK = 1.0
# W_CENTERLINE = 0.5
# W_JUNCTION = 0.5

# Configuration 3: weak auxiliary weighting
# EXPERIMENT_NAME = "aux025"
# W_MASK = 1.0
# W_CENTERLINE = 0.25
# W_JUNCTION = 0.25

# Configuration 4: centerline-focused
# EXPERIMENT_NAME = "center_focus"
# W_MASK = 1.0
# W_CENTERLINE = 1.0
# W_JUNCTION = 0.25

# Configuration 5: junction-focused
EXPERIMENT_NAME = "junction_focus"
W_MASK = 1.0
W_CENTERLINE = 0.25
W_JUNCTION = 1.0

OUTPUT_DIR = Path(f"runs_unet_multihead_seed{SEED}_{EXPERIMENT_NAME}")
...
def main() -> None:
    ...
    print("Loss weights:")
    print(f"  lambda_mask       = {W_MASK}")
    print(f"  lambda_centerline = {W_CENTERLINE}")
    print(f"  lambda_junction   = {W_JUNCTION}")
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        row = {
            ...
            "seed": SEED,
            "lambda_mask": W_MASK,
            "lambda_centerline": W_CENTERLINE,
            "lambda_junction": W_JUNCTION,
